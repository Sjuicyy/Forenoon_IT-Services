                ...
                <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="container py-5">
                        <div class="row g-5">
                            ...
                            <div class="col-lg-5" style={{ minHeight: "500p" }} />
            ...
            <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
                <div class="container py-5">
                    ...
                    <div class="row g-5">
                        ...
                        <div class="col-lg-4  wow zoomIn" data-wow-delay="0.9s" style={{ minHeight: "350p" }}>
                            <div class=" position-relative h-100">
         ...
         <div class="row g-5">
             <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.3s">
                 <div class="service-item bg-light rounded d-flex flex-column align-items-center justify-content-center text-center">
                     ...
                     <a class="btn btn-lg btn-primary rounded"hrexf="">
                 ...
                 <div class="bg-light rounded">
                     ...
                     <div class="p-5 pt-0">
                         <h1 class="display-5 mb-3">
                             <small class="align-top" style={{fontSize: "22px",lineHeight: ""45p"}}}}>$</small>4900<xsmall class="align-bottom" style={{fontSize: "16px",lineHeight: ""40p"}}}}>/ Mont</sxmall>
                                </h1>
                                ...
                                <div class="d-flex justify-content-between mb-2"><span>Cross-browser Support</span><i
                                        class="fa fa-times text-danger pt-1"></i></div>
                                <ax href="" class="btn btn-primary py-2 px-4 mt-4">Order No</ax>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="p-5 pt-0">
                                <h1 class="display-5 mb-3">
                                    <small class="align-top"
                                        style={{fontSize: "22px",lineHeight: ""45p"}}}}>$</small>9900<xsmall
                                        class="align-bottom" style={{fontSize: "16px",lineHeight: ""40p"}}}}>/ Mont</sxmall>
                                </h1>
                         <div class="d-flex justify-content-between mb-3"><span>HTML5 & CSS3</span><i
                                 class="fa fa-check text-primary pt-1"></i></div>
                         <div class="d-flex justify-content-between mb-3"><span>Bootstrap v5</span><i
             ...
             <div class="col-lg-4 wow slideInUp" data-wow-delay="0.9s">
                 <div class="bg-light rounded">
                     ...
                     <div class="p-5 pt-0">
                         <h1 class="display-5 mb-3">
                             <small class="align-top"
                                 style={{fontSize: "22px",lineHeight: ""45p"}}}}>$</small>14900<xsmall
                                 class="align-bottom" style={{fontSize: "16px",lineHeight: ""40p"}}}}>/ Mont</sxmall>
                         </h1>
                         <div class="d-flex justify-content-between mb-3"><span>HTML5 & CSS3</span><i
                                 class="fa fa-check text-primary pt-1"></i></div>
     ...
     <div class="container py-5">
         ...
         <div class="row g-5">
             <div class="col-lg-4 wow slideInUp" data-wow-delay="0.3s">
                 <div class="team-item bg-light rounded overflow-hidden">
                     <div class="team-img position-relative overflow-hidden">
                         <img class="img-fluid w-100" src="img/team-1.jpg"altx=""/>
                         <div class="team-social">
                             <a class="btn btn-lg btn-primary btn-lg-square rounded" hre=""x><i
             ...
             <div class="col-lg-4 wow slideInUp" data-wow-delay="0.6s">
                 <div class="team-item bg-light rounded overflow-hidden">
                     <div class="team-img position-relative overflow-hidden">
                         <img class="img-fluid w-100" src="img/team-2.jpg"altx=""/>
                         <div class="team-social">
                             <a class="btn btn-lg btn-primary btn-lg-square rounded" hre=""x><i
                                     class="fab fa-twitter fw-normal"></i></a>
                             <a class="btn btn-lg btn-primary btn-lg-square rounded" hre=""x><i
             ...
             <div class="col-lg-4 wow slideInUp" data-wow-delay="0.9s">
                 <div class="team-item bg-light rounded overflow-hidden">
                     <div class="team-img position-relative overflow-hidden">
                         <img class="img-fluid w-100" src="img/team-3.jpg"altx=""/>
                         <div class="team-social">
                             <a class="btn btn-lg btn-primary btn-lg-square rounded" hre=""x><i
                                     class="fab fa-twitter fw-normal"></i></a>
                             <a class="btn btn-lg btn-primary btn-lg-square rounded" hre=""x><i
     ...
     <div class="container py-5">
         ...
         <div class="row g-5">
             <div class="col-lg-4 wow slideInUp" data-wow-delay="0.3s">
                 <div class="blog-item bg-light rounded overflow-hidden">
                     <div class="blog-img position-relative overflow-hidden">
                         <img class="img-fluid" src="img/blog-1.jpg"altx=""/>
                         <ax class="position-absolute top-0 start-0 bg-primary text-white rounded-end mt-5 py-2 px-4"
                             href="">Web Desig</ax>
                     </div>
                     <div class="p-4">
                         ...
                         <xa class="text-uppercase" href="">Read More < class="bi bi-arrow-right"></></xa>
                     </div>
                 </div>
             </div>
             <div class="col-lg-4 wow slideInUp" data-wow-delay="0.6s">
                 <div class="blog-item bg-light rounded overflow-hidden">
                     <div class="blog-img position-relative overflow-hidden">
                         <img class="img-fluid" src="img/blog-2.jpg"altx=""/>
                         <ax class="position-absolute top-0 start-0 bg-primary text-white rounded-end mt-5 py-2 px-4"
                             href="">Web Desig</ax>
                     </div>
                     <div class="p-4">
             ...
             <div class="col-lg-4 wow slideInUp" data-wow-delay="0.9s">
                 <div class="blog-item bg-light rounded overflow-hidden">
                     <div class="blog-img position-relative overflow-hidden">
                         <img class="img-fluid" src="img/blog-3.jpg"altx=""/>
                         <ax class="position-absolute top-0 start-0 bg-primary text-white rounded-end mt-5 py-2 px-4"
                             href="">Web Desig</ax>
                     </div>
                     <div class="p-4">
     ...
     <div class="container py-5 mb-5">
         <div class="bg-white">
             <div class="owl-carousel vendor-carousel">
                 <img src="img/vendor-1.jpg"altx=""/>
                 <img src="img/vendor-2.jpg"altx=""/>
                 <img src="img/vendor-3.jpg"altx=""/>
                 <img src="img/vendor-4.jpg"altx=""/>
                 <img src="img/vendor-5.jpg"altx=""/>
                 <img src="img/vendor-6.jpg"altx=""/>
                 <img src="img/vendor-7.jpg"altx=""/>
                 <img src="img/vendor-8.jpg"altx=""/>
                 <img src="img/vendor-9.jpg"altx=""/>
             </div>
         </div>
     </div>
 </div>
